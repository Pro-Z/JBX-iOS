...
#define BadgeTag 1104
#define NumberLabelTag 1103
#define NormalBadgeWidth 7
#define NumberBadgeWidth 18 // 带数字的最小宽度

static const char *offsetSizeKey = "badgeSizeKey";

@implementation UIView (DZBadge)
...
- (void)numberChangeByAdd:(BOOL)add {
    ...
    UILabel *numberLabel = [badgeView viewWithTag:NumberLabelTag];
    if (!numberLabel) {
        return;
    }
