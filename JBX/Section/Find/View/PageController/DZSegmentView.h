...
typedef NS_ENUM(NSUInteger, SegmentStyle) {
    SegmentStyleDefault,    /**< 指示杆和按钮的标题齐平*/
    SegmentStyleFlush,      /**< 指示杆和按钮宽度齐平*/
};
NS_ASSUME_NONNULL_BEGIN
FOUNDATION_EXPORT int const SegmentHeight;

@interface DZSegmentView : UIView
...
@property (nonatomic) SegmentStyle style;
