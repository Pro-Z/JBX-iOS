...
@interface NetSsoClient()

@property (nonatomic,strong) AFHTTPSessionManager *sessionManager;

@end
@implementation NetSsoClient
static NetSsoClient *_sharedNetAPIClient = nil;
...
+ (instancetype)shareNetAPIClient {
    ...
    dispatch_once(&onceToken, ^{
        _sharedNetAPIClient = [[NetSsoClient alloc] initWithBaseUrl:[NSURL URLWithString:APP_BASE_SSO_URL] withType:0];
    });
