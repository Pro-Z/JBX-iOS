...
static const CGFloat kPageControlDefaultLineWidth = 2.0f;
static const CGFloat kPageControlDefaultRadius = 10.0f;
static const CGFloat kPageControlDefaultPadding = 20.0f;
static const CGFloat kPageControlDefaultAnimationDuration = 0.3f;

#define kPageControlDefaultPageIndicatorTintColor [UIColor colorWithWhite:1 alpha:0.6]
#define kPageControlDefaultCurrentPageIndicatorTintColor [UIColor whiteColor]

@interface PageControl()<CAAnimationDelegate>
...
- (void)setup {
    _lineWidth = kPageControlDefaultLineWidth;
    _radius = kPageControlDefaultRadius;
    _padding = kPageControlDefaultPadding;
    
    _lastPage = 0;
    _numberOfPages = 0;
    _currentPage = 0;
    
    _pageIndicatorTintColor = kPageControlDefaultPageIndicatorTintColor;
    _currentPageIndicatorTintColor = kPageControlDefaultCurrentPageIndicatorTintColor;
...
- (void)_moveToPageWithAnimated:(BOOL)animated {
    ...
    if (animated) {
        ...
        animationGroup.duration = kPageControlDefaultAnimationDuration;
