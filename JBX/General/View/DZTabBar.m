...
- (instancetype)initWithFrame:(CGRect)frame
{
    if (self=[super initWithFrame:frame]) {
        ...
        [plusBtn setBackgroundImage:[UIImage imageNamed:@"center_icon"] forState:UIControlStateNormal];
        [plusBtn setBackgroundImage:[UIImage imageNamed:@"center_icon"] forState:UIControlStateHighlighted];
...
- (void)layoutSubviews
{
    ...
    //调整发布按钮的中线点Y值
//    if(self.height > 49){
//        self.plusBtn.centerY = (self.height-34) * 0.5 - 2*DZMargin ;
//    }else {
//        self.plusBtn.centerY = self.height * 0.5 - 2*DZMargin ;
//    }
    if(self.height > 49){
        self.plusBtn.centerY = (self.height-34) * 0.5;
    }else {
...
//        _label.centerY = self.plusBtn.frame.size.height - 24 + DZMargin ;
//    }else {
//        _label.centerX = self.plusBtn.centerX;
//        _label.centerY = CGRectGetMaxY(self.plusBtn.frame) + DZMargin ;
//    }
//
